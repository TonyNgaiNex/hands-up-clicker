    ...
    public class AH_DependencyGraphWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (dependencyGraphManager != null)
            {
                ...
                {
                    Heureka_WindowStyler.DrawCenteredMessage(window, AH_EditorData.Instance.RefFromIcon.Icon, 240f, 110f, "No Graph" + Environment.NewLine + "Build Graph");
                ...
                {
                    Heureka_WindowStyler.DrawCenteredMessage(window, AH_EditorData.Instance.RefFromIcon.Icon, 240f, 110f, "No selection" + Environment.NewLine + "Select asset in project view");
                }
            }
            doFooter();
        ...
        {
            Heureka_WindowStyler.DrawGlobalHeader(window, AH_EditorData.Instance.WindowHeaderIcon.Icon, Heureka_WindowStyler.clr_lBlue, WINDOWNAME);
