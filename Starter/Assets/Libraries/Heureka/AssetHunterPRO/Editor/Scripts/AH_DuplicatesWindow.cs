    ...
    public class AH_DuplicatesWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (duplicateDataManager != null)
            {
                ...
                {
                    Heureka_WindowStyler.DrawCenteredMessage(window, AH_EditorData.Instance.DuplicateIcon.Icon, 240f, 110f, "No data" + Environment.NewLine + "Find duplicates");
                ...
                else
                {
                    ...
                    { 
                        Heureka_WindowStyler.DrawCenteredMessage(window, AH_EditorData.Instance.DuplicateIcon.Icon, 240f, 110f, "Hurray" + Environment.NewLine + "No duplicates assets" + Environment.NewLine + "in project :)");
                        GUILayout.FlexibleSpace();
                    }
                    else
                     doBody();
        ...
        {
            Heureka_WindowStyler.DrawGlobalHeader(window, AH_EditorData.Instance.WindowHeaderIcon.Icon, Heureka_WindowStyler.clr_Red, WINDOWNAME);
        }
        private void doBody()
        {
